...
type HmmEstimator struct {
  hmm1        *matrixDistribution.Hmm
  hmm2        *matrixDistribution.Hmm
  hmm3        *matrixDistribution.Hmm
  data         HmmDataSet
...
func NewHmmEstimator(pi Vector, tr Matrix, stateMap, startStates, finalStates []int, estimators []VectorEstimator, epsilon float64, maxSteps int, args... interface{}) (*HmmEstimator, error) {
  if hmm, err := matrixDistribution.NewHmm(pi, tr, stateMap, nil); err != nil {
    return nil, err
  } else {
...
func (obj *HmmEstimator) GetEstimate() MatrixDistribution {
  return obj.hmm1
}
