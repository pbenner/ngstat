...
func (obj *VectorIid) CloneVectorDistribution() VectorDistribution {
  return obj.Clone()
}
...
func (obj *VectorIid) ExportConfig() (config ConfigDistribution) {
  ...
  return NewConfigDistribution("vector:vector iid connector", parameters, obj.Distribution.ExportConfig())
}
