...
type LikelihoodClassifier struct {
  FgDist ScalarDistribution
  BgDist ScalarDistribution
  r1, r2 Scalar
}

/* -------------------------------------------------------------------------- */

func NewLikelihoodClassifier(fgDist ScalarDistribution, bgDist ScalarDistribution, args... interface{}) (*LikelihoodClassifier, error) {
  ...
  return &LikelihoodClassifier{fgDist.CloneScalarDistribution(), bgDist.CloneScalarDistribution(), NewScalar(t, 0.0), NewScalar(t, 0.0)}, nil
}
...
func NewSymmetricClassifier(fgDist ScalarDistribution, bgDist ScalarDistribution, args... interface{}) (*SymmetricClassifier, error) {
...
func NewPosteriorClassifier(fgDist ScalarDistribution, bgDist ScalarDistribution, weights [2]float64, args... interface{}) (*PosteriorClassifier, error) {
  if classifier, err := NewLikelihoodClassifier(fgDist, bgDist, args...); err != nil {
    return nil, err
  } else {
...
func NewPosteriorOddsClassifier(fgDist ScalarDistribution, bgDist ScalarDistribution, weights [2]float64, args... interface{}) (*PosteriorOddsClassifier, error) {
