...
func (obj *CoreHmm) bareRealForward(data AbstractDataRecord, alpha *DenseBareRealMatrix, t1, t2 *BareReal, n, m int) (*DenseBareRealMatrix, error) {
...
func (obj *CoreHmm) bareRealBackward(data AbstractDataRecord, beta *DenseBareRealMatrix, t1, t2 *BareReal, n, m int) (*DenseBareRealMatrix, error) {
...
func (obj *CoreHmm) bareRealForwardBackward(data AbstractDataRecord, alpha, beta *DenseBareRealMatrix, t1, t2 *BareReal) (*DenseBareRealMatrix, *DenseBareRealMatrix, error) {
  var err error
