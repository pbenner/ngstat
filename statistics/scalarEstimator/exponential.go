...
func (obj *ExponentialEstimator) EstimateOnData(x []Scalar, gamma DenseBareRealVector, p ThreadPool) error {
...
func (obj *ExponentialEstimator) GetEstimate() ScalarDistribution {
  if obj.sum_m != nil {
    obj.updateEstimate()
  }
